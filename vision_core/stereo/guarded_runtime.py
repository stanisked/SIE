...
"""Guarded live stereo-depth processing for SIE Vision Core."""
...
DEFAULT_NUM_DISPARITIES = 160
VALIDATED_PROFILES = {
    160: "stereo_runtime_v1_sgbm160",
    192: "stereo_runtime_v2_sgbm192_roi100",
}
...
class GuardedStereoDepthProcessor:
    ...
    def __init__(
        ...
        *,
        ...
        if num_disparities not in VALIDATED_PROFILES:
            raise ValueError(
                "unsupported num_disparities; validated values are "
                f"{sorted(VALIDATED_PROFILES)}"
            )
        self.guard = guard
        self.calibration = calibration
        self.parameters = calibration.parameters
        self.num_disparities = num_disparities
        self.runtime_profile_id = VALIDATED_PROFILES[num_disparities]
        self.sequence = 0
