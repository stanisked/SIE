...
def default_plan() -> DatasetPlan:
    ...
    rows += [s(f"partial_{p}_1_5m", "A", 1, "partial", 1.5, p, "front", "One person at 1.5 m in the natural partial view of the fixed robot camera.") for p in ("center", "left", "right")]
    rows += [s(f"full_{p}_4_0m", "A", 1, "full_body", 4.0, p, "front", "One person, full body visible with margin at 4.0 m.") for p in ("center", "left", "right")]
