...
def default_plan() -> DatasetPlan:
    ...
    rows += [s(f"upper_{p}_1_5m", "A", 1, "upper_body", 1.5, p, "front", "One person, upper body visible at 1.5 m.") for p in ("center", "left", "right")]
    rows += [s(f"full_{p}_3_5m", "A", 1, "full_body", 3.5, p, "front", "One person, full body visible at 3.5 m.") for p in ("center", "left", "right")]
