...
def test_default_plan_counts_and_strict_schema():
    ...
    assert [x.scenario_id for x in p.scenarios[3:9]] == ["partial_center_1_5m", "partial_left_1_5m", "partial_right_1_5m", "full_center_4_0m", "full_left_4_0m", "full_right_4_0m"]
