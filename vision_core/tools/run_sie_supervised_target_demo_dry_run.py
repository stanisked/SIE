#!/usr/bin/env python3
"""Run one supervised five-cycle target demo window without any action execution."""
...
from vision_core.person_approach.supervised_target_dry_run import SupervisedTargetDryRun  # noqa: E402
...
def main() -> int:
    ...
    try:
        runtime = build_live_runtime(
            model=args.model, reference=args.reference, project_root=args.project_root,
            person_threshold=args.person_threshold,
        )
        runtime.start()
        runner = SupervisedTargetDryRun(
