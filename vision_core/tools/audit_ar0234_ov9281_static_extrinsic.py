#!/usr/bin/env python3
"""Audit a static-only AR0234 to OV9281 extrinsic dataset offline."""
...
def main() -> int:
    ...
    try:
        ...
        write_offline_audit_outputs(output_dir=arguments.output_dir, report=report)
