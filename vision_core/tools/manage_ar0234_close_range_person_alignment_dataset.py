...
from vision_core.close_range_person_alignment_dataset.labels import create_session_splits, validate_yolo_labels
...
def main(argv: list[str] | None = None) -> int:
    ...
    result = create_session_splits(args.output_root) if args.create_session_splits else validate_yolo_labels(args.output_root)
