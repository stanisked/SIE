...
label `person_upper_body`. Рамка начинается у верхней границы головы и включает
голову, плечи, руки и видимую часть торса до пояса или верхней части бёдер.
Ноги и ступни всегда исключаются. Нижняя граница изображения допустима только
когда торс действительно обрезан границей кадра; при видимых ногах рамка не
идёт до ступней. Не размечай отдельно лицо.
